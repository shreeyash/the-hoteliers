...
public class Employees extends javax.swing.JFrame {
    ...
    public void setListener(){
         search_field.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                if(search_field.getText().equals("Enter Employee Name")){
    ...
    private void initComponents() {
        ...
        emp_table.setFont(new java.awt.Font("SansSerif", 0, 18)); // NOI18N
        emp_table.setForeground(new java.awt.Color(112, 112, 112));
        emp_table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Employee ID", "Name", "Salary", "Joining Date", "Role", "Phone"
            }
        ) {
        ...
        emp_table.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        emp_table.setGridColor(new java.awt.Color(153, 153, 153));
        ...
        SubmitButton1.setText("Show Employees");
        ...
        SubmitButton3.setText("Delete Employee");
        ...
        search_field.setText("Enter Employee Name");
                        ...
                        .addGroup(bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(bgLayout.createSequentialGroup()
                                ...
                                .addGroup(bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(search_field, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 253, Short.MAX_VALUE)
    ...
    private void HomeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HomeButtonActionPerformed
        Employees.this.setVisible(false);
    ...
    private void SubmitButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitButton1ActionPerformed
        DefaultTableModel m = (DefaultTableModel)emp_table.getModel();
    ...
    private void SubmitButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitButton3ActionPerformed
        ...
        try{
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3307/hms?autoReconnect=true&useSSL=false", "root", "aman123456");
            Statement st = con.createStatement();
            String q0 = "select emp_id from logged_in_hotel_id where emp_id = '"+ id +"'";
            ResultSet rs0 = st.executeQuery(q0);
            if(rs0.next()){
                JOptionPane.showMessageDialog(null, "Deletion Failed! User is active");
            } else {
    ...
    private void SubmitButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitButton4ActionPerformed
        ...
        try{
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3307/hms?autoReconnect=true&useSSL=false", "root", "aman123456");
            Statement st = con.createStatement();
            String q = "select * from employee where emp_name = '"+ fname +"'";
            ResultSet rs = st.executeQuery(q);
