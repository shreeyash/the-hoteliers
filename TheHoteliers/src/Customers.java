...
public class Customers extends javax.swing.JFrame {
     ...
     public void setListener(){
         search_field.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                if(search_field.getText().equals("Enter Customer First Name")){
    ...
    private void initComponents() {
        ...
        cust_table.setFont(new java.awt.Font("SansSerif", 0, 18)); // NOI18N
        cust_table.setForeground(new java.awt.Color(112, 112, 112));
        cust_table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Customer ID", "First Name", "Last Name", "Phone Number", "Address"
            }
        ) {
        ...
        cust_table.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        cust_table.setGridColor(new java.awt.Color(153, 153, 153));
        cust_table.setRowHeight(20);
        ...
        SubmitButton1.setText("Show Customers");
        ...
        SubmitButton3.setText("Delete Customer");
        ...
        search_field.setText("Enter Customer First Name");
                            ...
                            .addGroup(bgLayout.createSequentialGroup()
                                ...
                                .addGroup(bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(SubmitButton, javax.swing.GroupLayout.DEFAULT_SIZE, 253, Short.MAX_VALUE)
                                        .addGroup(bgLayout.createSequentialGroup()
                                            .addComponent(jLabel12, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addGap(99, 99, 99)))
                                    .addComponent(search_field, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 253, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(SubmitButton4, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void HomeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HomeButtonActionPerformed
        Customers.this.setVisible(false);
    ...
    private void SubmitButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitButton1ActionPerformed
        DefaultTableModel m = (DefaultTableModel)cust_table.getModel();
    ...
    private void SubmitButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitButton3ActionPerformed
        ...
        try{
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3307/hms?autoReconnect=true&useSSL=false", "root", "aman123456");
            Statement st = con.createStatement();
//           =================================Delete room instance of the booking created for the customer===========================
            String q = null;
            q = "select book_id from booking where book_cust_id = '"+ id +"'";
            ResultSet rs = st.executeQuery(q);
            if(rs.next()){
                q = "update rooms set room_book_id = null, room_status = 'v' where room_book_id = '"+ rs.getString("book_id") +"'";
                st.executeUpdate(q);
                q = "delete from booking where book_cust_id = '"+ id +"'";
                st.executeUpdate(q);
            }
    ...
    private void SubmitButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitButton4ActionPerformed
        String fname = search_field.getText();
        try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3307/hms?autoReconnect=true&useSSL=false", "root", "aman123456");
            Statement st = con.createStatement();
            String q = "select * from customer where cust_fname = '"+ fname +"'";
            ResultSet rs = st.executeQuery(q);
